...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
          <form class="d-flex" action="estudiantes.php" method="post">
            <div class="col">
            <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <select class="form-select" name="drop_puesto" id="drop_puesto">
                  ...
                  <?php 
                   ...
                   $conexion -> real_query ("SELECT id_estudiantes as estudiantes FROM estudiantes;");
    ...
    $('#tb_estudiantes').on('click','tr td',function(evt){
