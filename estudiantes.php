     ...
     //print_r( $_POST );
      ...
      include("datos_conexion.php");
        ...
        if(isset($_POST['btn_agregar'])  ){
          $sql = "INSERT INTO colegio.estudiantes(id_estudiantes,carnet,nombres,apellidos,direccion,telefono,genero,email,fecha_nacimiento) VALUES ('".$txt_id_estudiantes ."','". $txt_nombres ."','". $txt_apellidos ."','". $txt_direccion ."','". $txt_telefono ."','". $txt_fn ."',". $txt_carnet .");";
        }
        ...
        if( isset($_POST['btn_eliminar'])  ){
          $sql = "delete from colegio.estudiantes  where id_estudiantes = ". $txt_id_estudiantes.";";
        }
